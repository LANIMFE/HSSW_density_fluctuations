Module general_structural_functions
	...
	Subroutine s_writting(k,sk,skf,kw,i_unit)
		Implicit None
		Real * 8, dimension(:), intent(in) :: k, sk, kw,skf
		Integer :: i1
		Integer, intent(in) :: i_unit
		!k S(k) kw WRITTING
		Write (i_unit,*) "# 			k 								S(k)								Weights"
		Do i1=1, size(k)
			Write(i_unit,*) k(i1),sk(i1),kw(i1),skf(i1)
		End Do
	End Subroutine
	...
	Subroutine file_name_constructor(sys,sysp,folder,preffix,id,suffix,file_name)
		...
		case("HDSW")
			...
			Write(id_char,"(I2.2)") id
			!Writting System ID
			sys_ID = trim("_HDSW_phi_"//phi_char//"_T_"//T_char//"_L_"//L_char//"_id_"//id_char)
		case("HDAY")
			!Formats
			Write(FMT1,"(A2,I1,A1,I1,A5,I1,A1,I1,A1)") "(I",i_T_m,".",i_T_m,",A1,I",di_T_m,".",di_T_m,")"
			Write(FMT2,"(A2,I1,A1,I1,A5,I1,A1,I1,A1)") "(I",i_z_m,".",i_z_m,",A1,I",di_z_m,".",di_z_m,")"
			...
			!Writting System ID
			sys_ID = trim("_HDAY_phi_"//phi_char//"_T_"//T_char//"_z_"//z_char//"_id_"//id_char)
		case default
