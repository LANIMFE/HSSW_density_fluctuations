Module hdsw_structure
  ...
  Contains
    ...
    Function is_hdsw_shvw(phi,T,z,k,qn,qw) result(is)
      ...
      Real * 8, Intent(in), dimension(:) :: qw  !Quadrature weights
      Real * 8 :: is
      is =  phi * c_hdsw_shvw(phi,T,z,k,qn,qw)
      is = 1.d0 - 4.d0 * is / pi
      return
    End Function
    ...
    Function s_hdsw_shvw(phi,T,z,k,qn,qw) result(s)
      ...
      Real * 8, Intent(in), dimension(:) :: qw  !Quadrature weights
      Real * 8 :: s
      s = 1.d0 / is_hdsw_shvw(phi,T,z,k,qn,qw)
      return
    End Function
    ...
    Function is_hdsw_gsvw(phi,T,z,k,qn,qw) result(is)
      ...
      Real * 8, Intent(in), dimension(:) :: qw  !Quadrature weights
      Real * 8 :: is
      is =  phi * c_hdsw_gsvw(phi,T,z,k,qn,qw)
      is = 1.d0 - 4.d0 * is / pi
      return
    End Function
    ...
    Function s_hdsw_gsvw(phi,T,z,k,qn,qw) result(s)
      ...
      Real * 8, Intent(in), dimension(:) :: qw  !Quadrature weights
      Real * 8 :: s
      s = 1.d0 / is_hdsw_gsvw(phi,T,z,k,qn,qw)
      return
    End Function
