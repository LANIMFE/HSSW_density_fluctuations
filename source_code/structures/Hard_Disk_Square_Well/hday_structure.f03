Module hday_structure
  ...
  Contains
    ...
    !Quadrature points vector "qn", the range should be qn E [1:-ln(10**-16)/z]
    !Quadrature weights "qw"
    Function c_hday_shvw(phi,T,z,k,qn,qw) result(c)
      Implicit None
    ...
    Function is_hday_shvw(phi,T,z,k,qn,qw) result(is)
      Implicit None
      Real * 8, Intent(in) :: phi !Volume fraction value
      Real * 8, Intent(in) :: T !Temperature
      Real * 8, Intent(in) :: z !Yukawa potential length parameter
    ...
    !temperature "T" for "T>0"
    !Yukawa potential length parameter "z>0"
    Function s_hday_shvw(phi,T,z,k,qn,qw) result(s)
      Implicit None
      Real * 8, Intent(in) :: phi !Volume fraction value
      Real * 8, Intent(in) :: T !Temperature
      Real * 8, Intent(in) :: z !Yukawa potential length parameter
    ...
    !temperature "T" for "T>0"
    !Yukawa potential length parameter "z>0"
    Function c_hday_gsvw(phi,T,z,k,qn,qw) result(c)
      Implicit None
      Real * 8, Intent(in) :: phi !Volume fraction value
      Real * 8, Intent(in) :: T !Temperature
      Real * 8, Intent(in) :: z !Yukawa potential length parameter
    ...
    Function is_hday_gsvw(phi,T,z,k,qn,qw) result(is)
      Implicit None
      Real * 8, Intent(in) :: phi !Volume fraction value
      Real * 8, Intent(in) :: T !Temperature
      Real * 8, Intent(in) :: z !Yukawa potential length parameter
    ...
    !temperature "T" for "T>0"
    !Yukawa potential length parameter "z>0"
    Function s_hday_gsvw(phi,T,z,k,qn,qw) result(s)
      Implicit None
      Real * 8, Intent(in) :: phi !Volume fraction value
      Real * 8, Intent(in) :: T !Temperature
      Real * 8, Intent(in) :: z !Yukawa potential length parameter
